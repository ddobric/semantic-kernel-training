...
namespace FoundryAgentDemo
{
    ...
    /// </summary>
    internal class FoundryResponsesAgentWithFileSample
    {
        /// <summary>
            ...
            AIAgent agent = new AIProjectClient(
                 new Uri(projectEndpoint),
                         ...
                         .AsAIAgent(
                           ...
                           name: nameof(FoundryResponsesAgentWithFileSample),
...
#pragma warning disable OPENAI001 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
        ...
        public async Task RunWithFileAsync()
        {
            ...
            try
            {
                ...
                string prompt = "Extract from this document the Author, the year and the title.";
